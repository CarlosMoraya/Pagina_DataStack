  ...
  return (
    <div className="pt-20">
      ...
      <section className="bg-brand-900 py-20 text-center">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl text-brand-300 max-w-2xl mx-auto">
            Empresas que aplicam inteligência logística com a Data Stack para transformar dados em decisões.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <p className="text-center text-brand-500 mb-12 uppercase tracking-widest font-semibold text-sm">Empresas que transformamos com inteligência logística</p>
